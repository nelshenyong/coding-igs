...
class Pipe():
    ...
    def __init__(self, Game, position):
        ...
        self.rect = pygame.Rect(0, 0, 0.10*self.screen_rect.width, 0.4*self.screen_rect.height)
        self.head_rect = pygame.Rect(0, 0, 1.2*self.rect.width, 0.12*self.rect.height)
